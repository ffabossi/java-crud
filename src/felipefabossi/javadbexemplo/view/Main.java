package felipefabossi.javadbexemplo.view;

import java.sql.SQLException;
import java.util.List;

import felipefabossi.javadbexemplo.dao.Contato;
import felipefabossi.javadbexemplo.dao.ContatoDAOImpl;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println();
            System.out.println("..JavaDB Opções..");
    ...
    private static void adicionar() {
        ...
        try {
            contatoDAO.add(c);
            System.out.println(
                    "Contato \"" + c.getNome() + " | " + c.getTelefone() + " | " + c.getEmail() + "\"  adicionado.");
    ...
    private static void buscar() {
        ...
        try {
            ...
            System.out.println(
                    "Contato: (ID: " + c.getId() + ") " + c.getNome() + " | " + c.getTelefone() + " | " + c.getEmail());
    ...
    private static void buscarPorNome() {
        ...
        try {
            ...
            for (Contato c : contatos) {
                System.out.println("Contato: (ID: " + c.getId() + ") " + c.getNome() + " | " + c.getTelefone() + " | "
                        + c.getEmail());
            }
        } catch (ContatoNaoExisteException | SQLException e) {
            System.out.println(e.getMessage());
