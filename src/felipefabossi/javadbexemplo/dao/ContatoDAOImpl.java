...
public class ContatoDAOImpl implements ContatoDAO {
    ...
    // <editor-fold defaultstate="expand" desc="Comando(s) de Criação/Escrita
    // (CREATE)">
    @Override
    ...
    public Contato getContato(int id)
        ...
        try {
            ...
            while (rs.next()) {
                contato = new Contato(rs.getInt("id"), rs.getString("nome"), rs.getString("telefone"),
                        rs.getString("email"));
            }
    ...
    public List<Contato> getContatosPorNome(String nome)
        ...
        try {
            ...
            while (rs.next()) {
                Contato contato = new Contato(rs.getInt("id"), rs.getString("nome"), rs.getString("telefone"),
                        rs.getString("email"));
    ...
    // <editor-fold defaultstate="expand" desc="Comando(s) de Atualização/Alteração
    // (UPDATE)">
    @Override
    ...
    // <editor-fold defaultstate="expand" desc="Comando(s) de Exclusão/Remoção
    // (DELETE)">
    @Override
